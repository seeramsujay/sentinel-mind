                ...
                <section className="w-[320px] bg-white p-6 flex flex-col gap-6 relative z-40 border-l border-slate-200">
                    <div className="flex-1 overflow-y-auto custom-scrollbar">
                        ...
                        <div className="aspect-video w-full bg-slate-100 rounded-lg overflow-hidden relative border border-slate-200 mt-6 group">
                            <img alt="Preview" className="w-full h-full object-cover grayscale transition-all group-hover:grayscale-0" src="https://lh3.googleusercontent.com/aida-public/AB6AXuDFcfCaVGsX6cvaTIqxJJ0IrgxPniIR6C1hJuA9iqhmhCjQ99am3v01QsVGYQJo3bj8PJz0DmmY2Q9MaSizku06Z3NYg6vthdZzOMEAa1K1YSDIJFWNd2hSXITGn3c1Tj6A8hjXIaQyPNvg6mHzu5PpRVDjC_tAes0E0j1kNLRI904SRu-T84Wj2XKhBM7GvI5ZDX7U1O3cZsxnVqHgpnAaxTdTUlZtPVI7pZ6frnxoGVMb4wwTaN2FWShR-nAptMpDagKD7mzFcv8"/>
